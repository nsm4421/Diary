...
class _MediaCarousel extends StatelessWidget {
  _MediaCarousel({
    ...
    final widths = medias
        ...
        .where((e) => e != null)
        .map((e) => e!);
    _height = heights.isEmpty
        ? null
        : heights.reduce((a, b) => a > b ? a : b).toDouble();
    _width = widths.isEmpty
        ? null
        : widths.reduce((a, b) => a > b ? a : b).toDouble();
  }
                    ...
                    ColoredBox(
                      ...
                      child: Image.file(
                        ...
                        errorBuilder: (context, error, stackTrace) {
                          debugPrint('carousel error : ${error.toString()}');
                          return Center(
                            child: Icon(
